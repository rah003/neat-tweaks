 ...
 * @param <T> Type.
 */
public class PropertyScriptTransformer<T> extends BasicTransformer<T> {

    public PropertyScriptTransformer(Item relatedFormItem, ConfiguredFieldDefinition definition, Class<T> type) {
